...
class my_top_block1(gr.top_block):
    ...
    def __init__(self, demodulator, rx_callback, options):
        ...
        self.rxdata = gr.file_sink(gr.sizeof_gr_complex, "node2_rx_data.dat") 
...
class my_top_block(gr.top_block):
    def __init__(self, modulator, options):
        ...
        self.tx_data = gr.file_sink(gr.sizeof_gr_complex,"node2_tx_data.dat")
...
def main():
    ...
    def rx_callback(ok, payload):
        #tb.connect(tb.source, tb.rxdata)
        #tb.save_rx()
